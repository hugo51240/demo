document.addEventListener('DOMContentLoaded', () => {
  const applicationServerKey =
    'BDhHDo8uL0-mquPqRdLGVSv-pbEbT0WT_S9NTaBsCPLidlDroOuFkHAF-m7GRmtMpuVERJ3GqEZ3dCCoeMAy5eg';
  ...
  function push_sendSubscriptionToServer(subscription, method) {
    ...
    return fetch('C:/xampp/htdocs/web-push-php-example/src/push_subscription.php', {
      method,
      body: JSON.stringify({
  ...
  sendPushButton.addEventListener('click', () =>
    navigator.serviceWorker.ready
      ...
      .then(subscription => {
        ...
        fetch('C:/xampp/htdocs/web-push-php-example/src/send_push_notification.php', {
          method: 'POST',
